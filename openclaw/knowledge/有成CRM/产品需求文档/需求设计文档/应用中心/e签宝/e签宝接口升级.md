...
fileName
signFlowConfig
signFlowTitle | code | [基于文件发起签署](https://open.esign.cn/doc/opendoc/pdf-sign3/nxhgcl3bfgqz8qlz) | **重大变化**
1\. V3采用统一的签署流程管理
2\. 新增签署方配置signers参数
3\. 支持更多签署方式和参数配置 |
...
logType
operateDescription
operateTime | 查询签署流程详情 | GET /v3/sign-flow/\{signFlowId\} | signFlowId(path) | signFlowInfo
signTaskInfos
...
fileId
fileName
fileUrl | 查询合同列表 | GET /v3/contracts | contractIds(是) | contracts | [V3文档](https://open.esign.cn/doc/opendoc/contract3/ln452t) | **功能增强**
V3支持更多合同查询和管理功能 |
