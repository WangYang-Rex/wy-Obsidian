---
title: " mb端单据详情-审批历史（收起）中展示上一节点审批信息"
nodeId: Qnp9zOoBVBZzNDrmtL2mk6bXV1DK0g6l
...
### 需求现状
1. 审批人在mb端查看待审批的单据详情时，在单据详情收起的审批历史中只能看到最新审批节点信息，其实就是自己作为当前审批节点审批人的信息，无法快速看到前一节点审批人信息，需要查看详情展开查看

### 客户预期：

在mb端查看单据详情时，收起的审批历史中可看到上一节点审批信息
...
| 模块 | 功能点 | 备注 |
|------|---------|------|
| mb端-单据详情-审批历史（收起） | 支持展示上一节点审批信息 | 仅mb端 |

---

## 三、功能需求

### 3.1 mb端单据详情-审批历史（收起）中展示上一节点审批信息
