...
| 20250730 | v1.0 | 新建 |
| 20250905 | v2.0 | 调整 |
| 20251010 | v2.1 | 优化：☑ 重新登录依然保留对话、引导用户通过新建对话重新建单——2@吴靖(岱宗-吴靖)☑ 首页增加“去报销”入口——5☑ 支持发票和消费混合提交场景——3☑ 自动计算补贴——1☐ 生成单据兼容单据模板上配置的填写逻辑（辅助核算带出上一次选项）——7☑ 支持企业级智能填单规则——4@吴靖(岱宗-吴靖)☑ 咨询费用标准，支持其他标准——0@吴靖(岱宗-吴靖)☑ 自动带入单据申请人（暂不支持委托报销场景，v4.3优化）——6 |
